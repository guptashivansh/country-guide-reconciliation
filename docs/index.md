...
| [Semantic Reconciliation](modules/semantic-reconciliation.md) | Compliance Leadership, Architects | LLM classification rationale, materiality framework, fail-open behavior |
